                ...
                <div class="card-body">
                    ...
                    <div class="my-2">
                        ...
                        @foreach($covers as $cover)
                                <input type="checkbox" class="btn-check" id="{{$cover->id}}" name="{{$cover->type}}[]" value="{{$cover->name}}" autocomplete="off">
                        ...
                        @foreach($bodys as $body)
                                <input type="checkbox" class="btn-check" id="{{$body->id}}" name="{{$body->type}}[]" value="{{$body->name}}" autocomplete="off">
                        ...
                        @foreach($specials as $special)
                                <input type="checkbox" class="btn-check" id="{{$special->id}}" name="{{$special->type}}[]" value="{{$special->name}}" autocomplete="off">
